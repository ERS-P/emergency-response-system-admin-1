...
const Panel = () => {
    return (
        <div style={{display: "flex", flex: .14, flexDirection: "column", padding: "4em 0"}} >
            <Tab to="/" title="Dashboard" icon={Screen} color="#5e71e4" />
            <Tab to="/users" title="Users" icon={User} color="#fed702" />
            <Tab to="/track-location" title="Track Location" icon={Marker} color="#fb6340" />
            <Tab to="/notifications" title="Notifications" icon={Bell} color="#f5365b" />
